$(document).ready(function () {
  ...
  $('.theme_tab-content thead input[type="checkbox"]').change(function () {
    if ($(this).is(':checked')) {
      $(this).parents('.theme_table').find('input[type="checkbox"]').not($(this)).prop('checked', true);
    }
    else {
      $(this).parents('.theme_table').find('input[type="checkbox"]').not(this).prop('checked', false);
    }
  })


  // Tick indicator 
  // $('.tick_indicator').click(function(){

  //   if($(this).prev('input').is(':checked')){
  //     $(this).prev('input').prop("checked", false);
  //     $('.funnel_step-next-btn').prop('disabled', true);
  //     $('.funnel_step-next-btn').removeClass("theme_btn-primary");
  //     // $('#enable_quantity').prop('disabled', false);
  //     // $('.enable_quantity_input').prop('disabled', false);
  //     // $(".enable_quantity_div").removeClass("enable_input_bg");
  //   }
  //   else{
  //     $(this).prev('input').prop("checked", true);
  //     $('.funnel_step-next-btn').prop('disabled', false);
  //     $('.funnel_step-next-btn').addClass("theme_btn-primary");
  //     // $('#enable_quantity').prop('disabled');
  //     // $('.enable_quantity_input').prop('disabled');
  //     // $(".enable_quantity_div").addClass("enable_input_bg");
  //   }
